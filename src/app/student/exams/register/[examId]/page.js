// ============================================
// FILE: src/app/student/exams/register/[examId]/page.js (ATTRACTIVE UI)
// ============================================
'use client';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-8 shadow-lg">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center">
            <div className="bg-white rounded-full p-3 shadow-xl mb-4">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold text-gray-800 mb-2">විභාගය සඳහා ලියාපදිංචිවීම</h2>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            <div className="flex items-start justify-between mb-6">
              <div className="flex-1">
                <h3 className="text-3xl font-bold text-gray-800 mb-2">{exam.exam_name}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <div>
                  <p className="text-xs text-green-600 font-semibold uppercase">Registration Opens</p>
                  <p className="text-sm font-bold text-gray-800">{formatDate(exam.registration_start_date)}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-red-50 rounded-lg border border-red-200">
                ...
                <div>
                  <p className="text-xs text-red-600 font-semibold uppercase">Registration Closes</p>
                  <p className="text-sm font-bold text-gray-800">{formatDate(exam.registration_end_date)}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-800">විෂය තෝරන්න</h3>
              <p className="text-sm text-gray-600">ඔබ සම්බන්ද වීමට බලාපොරොත්තු වන විෂයන් සියල්ල සලකුණු කරන්න</p>
            </div>
          </div>
          ...
          {selectedSubjects.length > 0 && (
            <div className="mb-4 p-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200">
              <div className="flex items-center justify-between">
                <span className="text-sm font-semibold text-gray-700">Selected Subjects:</span>
          ...
          <div className="space-y-2 max-h-96 overflow-y-auto p-2 border-2 border-dashed border-gray-200 rounded-xl">
            {availableSubjects.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-lg">No subjects available for this exam</p>
              </div>
            )}
          </div>
          ...
          <div className="mt-8 flex gap-4 justify-end">
            <button 
              ...
              className="px-6 py-3 bg-gray-100 hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed text-gray-700 font-semibold rounded-xl transition-all duration-200 border-2 border-gray-300 hover:border-gray-400 flex items-center gap-2"
            >
            ...
            <button 
              ...
              className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 disabled:transform-none flex items-center gap-2"
            >
              {registering ? (
                <>
          ...
          {selectedSubjects.length > 0 && (
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200 flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-blue-800 font-medium">Registration Confirmation</p>
                <p className="text-xs text-blue-600 mt-1">You are about to register for {selectedSubjects.length} subject{selectedSubjects.length !== 1 ? 's' : ''}. Click "Register for Exam" to complete your registration.</p>
              </div>
            </div>
          )}
        </div>
