...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (token) {
      // Redirect to dashboard based on role (fetch role from token if needed, or default to student)
      router.push('/student/dashboard'); // Make dynamic later based on role from token
    } else {
